...
async def logout(request: Request, response: Response):
    return user_ctrl.logout(request, response)
...
async def enable_mfa(session_id: session_id_dependency, request: Request):
    return user_ctrl.enable_mfa(session_id, request)
...
async def update_password(req_body: UserUpdatePasswordRequestSchema, session_id: session_id_dependency, request: Request):
    return user_ctrl.update_password(req_body, session_id, request)
